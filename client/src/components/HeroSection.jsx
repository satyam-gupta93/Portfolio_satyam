    ...
    >
      ...
      >
        ...
        >
          ...
          {isMusicPlaying && (
            <div className="absolute -right-1 cursor-pointer top-1/2 -translate-y-1/2 flex  gap-0.5">
              {[...Array(3)].map((_, i) => (
                <motion.div
                  key={i}
        ...
        <motion.button
          onClick={toggleTheme}
          className="relative group p-2.5 rounded-lg bg-background/80 backdrop-blur-sm border cursor-pointer border-transparent hover:border-red-500/30 transition-all duration-300"
          whileHover={{ scale: 1.1, y: -2 }}
          whileTap={{ scale: 0.95 }}
          initial={{ y: 20, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
      ...
      >
        ...
        >
          ...
          {/* Tooltip */}
          <motion.div
            className="absolute bottom-full right-0 mb-3 px-3 py-1.5 bg-background/90 backdrop-blur-sm border border-red-500/20 rounded-lg shadow-lg cursor-pointer"
          ...
          >
            <span className="text-xs font-mono text-red-500 whitespace-nowrap flex items-center gap-1 cursor-pointer ">
      ...
      {/* Scroll Indicator */}
      <motion.div
        className="absolute bottom-6 left-1/2 hidden -translate-x-1/2 transform flex-col  cursor-pointer items-center sm:flex "
