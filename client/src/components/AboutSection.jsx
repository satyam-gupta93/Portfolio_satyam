...
export const AboutSection = () => {
  return (
    <section id="about"
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-0 left-1/4 w-48 h-48 md:w-72 md:h-72 bg-red-500/10 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob"></div>
        <div className="absolute top-1/3 right-1/4 w-48 h-48 md:w-72 md:h-72 bg-red-500/10 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
        <div className="absolute bottom-0 left-1/2 w-48 h-48 md:w-72 md:h-72 bg-red-500/10 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-4000"></div>
      </div>

      <div className="container mx-auto max-w-6xl relative">
        {/* Section Header */}
        <div className="text-center mb-12 md:mb-16">
          <span className="inline-block px-3 py-1 text-xs sm:text-sm font-medium rounded-full bg-red-500/10 text-red-500 mb-3 sm:mb-4 transition-all duration-300 hover:scale-105 hover:bg-red-500/20">
            About Me
          </span>
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold transition-all duration-500 hover:text-red-500/80">
            Crafting Digital{' '}
        ...
        <div className="flex flex-col lg:flex-row gap-6 md:gap-8 items-stretch">
          ...
          {/* Left — Profile Card */}
          <div className="lg:w-1/2 group">
            <div className="h-full bg-muted/20 border border-muted rounded-xl md:rounded-2xl p-6 md:p-8 backdrop-blur-sm transition-all duration-500 hover:shadow-xl hover:border-red-500/30 hover:bg-muted/30 hover:-translate-y-1">
              <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-6">
                <div className="relative w-16 h-16 rounded-full overflow-hidden border-2 border-red-500/30 transition-all duration-300 group-hover:border-red-500/50 group-hover:scale-110 mx-auto sm:mx-0">
              ...
              <div className="space-y-4 md:space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                  <div className="bg-background p-3 sm:p-4 rounded-lg border border-muted transition-all duration-300 hover:border-red-500/50 hover:shadow-md hover:scale-[1.02]">
                ...
                <div className="flex flex-col sm:flex-row gap-3 md:gap-4 pt-4">
                  <a href="#contact"
                    className="px-4 py-2 sm:px-6 sm:py-3 bg-red-500 text-white rounded-lg hover:bg-red-500/90 transition-all duration-300 text-center hover:shadow-md hover:scale-[1.02] active:scale-95 text-sm sm:text-base">
                    Contact Me
                  </a>
                  <a href="/md sahil full stack resume.pdf"
                    className="px-4 py-2 sm:px-6 sm:py-3 rounded-lg border border-red-500/50 hover:border-red-500 hover:bg-muted/50 transition-all duration-300 flex items-center justify-center gap-2 hover:shadow-md hover:scale-[1.02] active:scale-95 text-sm sm:text-base"
                    download>
          ...
          {/* Right — Details */}
          <div className="lg:w-1/2 space-y-4 md:space-y-6">
            <div className="bg-muted/20 border border-muted rounded-xl md:rounded-2xl p-6 md:p-8 backdrop-blur-sm transition-all duration-500 hover:shadow-xl hover:border-red-500/30 hover:bg-muted/30 hover:-translate-y-1">
              <div className="flex items-start gap-3 md:gap-4">
                <div className="p-2 md:p-3 rounded-lg bg-red-500/10 text-red-500 transition-all duration-300 hover:bg-red-500/20 hover:scale-110">
                  <Code className="h-5 w-5 md:h-6 md:w-6" />
                </div>
                <div>
                  <h3 className="text-lg md:text-xl font-bold mb-2 transition-colors duration-300 hover:text-red-500">Development Philosophy</h3>
            ...
            <div className="bg-muted/20 border border-muted rounded-xl md:rounded-2xl p-6 md:p-8 backdrop-blur-sm transition-all duration-500 hover:shadow-xl hover:border-red-500/30 hover:bg-muted/30 hover:-translate-y-1">
              <div className="flex items-start gap-3 md:gap-4">
                ...
                <div>
                  <h3 className="text-lg md:text-xl font-bold mb-2 transition-colors duration-300 hover:text-red-500">Professional Approach</h3>
                  <p className="text-sm md:text-base text-muted-foreground">
                    With experience in both startups and enterprise environments,
                    I adapt my workflow to project needs. I value clear communication,
                    agile methodologies, and continuous learning.
            ...
            <div className="grid grid-cols-2 gap-3 md:gap-4">
              <div className="bg-muted/20 border border-muted rounded-xl md:rounded-2xl p-4 md:p-6 text-center transition-all duration-500 hover:shadow-xl hover:border-red-500/30 hover:bg-muted/30 hover:-translate-y-1">
